...
skill_first = Skill.create!(name: "Entraîneur", location: "2 rue du Moulin des Lapins, 75014 Paris", description: "J'enseigne aux enfants et aux adultes", user: user_one)
skill_first.save!
